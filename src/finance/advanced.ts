 ...
 * @returns Resultado correspondente à finalidade documentada: calcula pagamento periódico com fluxos de sinal oposto.
 */
 ...
 *
 * @param rate - Taxa fracionária por período.
 * @param cashFlows - Fluxos financeiros em ordem temporal.
 * @returns Resultado correspondente à finalidade documentada: calcula valor presente líquido de fluxos igualmente espaçados.
 ...
 *
 * @param cashFlows - Fluxos financeiros em ordem temporal.
 * @param tolerance - Tolerância numérica de convergência.
 * @param iterations - Número máximo de iterações.
 * @returns Resultado correspondente à finalidade documentada: aproxima taxa interna de retorno por bisseção limitada.
 * @throws Quando a entrada viola o contrato da operação (`RangeError`).
 */
 ...
 *
 * @param rate - Taxa fracionária por período.
 * @param fromPeriods - Quantidade de períodos da taxa de origem.
 * @param toPeriods - Quantidade de períodos da taxa de destino.
 * @returns Resultado correspondente à finalidade documentada: converte taxa efetiva entre quantidades de períodos.
 * @throws Quando a entrada viola o contrato da operação (`RangeError`).
 */
 ...
 * @param periods - Quantidade de períodos.
 * @returns Resultado correspondente à finalidade documentada: calcula parcela de amortização constante SAC.
 */
