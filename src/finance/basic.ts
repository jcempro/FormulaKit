 ...
 *
 * @param principal - Capital principal.
 * @param rate - Taxa fracionária por período.
 * @param periods - Quantidade de períodos.
 * @returns Resultado correspondente à finalidade documentada: calcula juros simples com taxa fracionária por período.
 */
 ...
 * @param rate - Taxa fracionária por período.
 * @param periods - Quantidade de períodos.
 * @returns Resultado correspondente à finalidade documentada: calcula montante composto com taxa fracionária por período.
 */
 ...
 * @param rate - Taxa fracionária por período.
 * @param periods - Quantidade de períodos.
 * @returns Resultado correspondente à finalidade documentada: calcula somente os juros compostos.
 */
 ...
 *
 * @param percentagePoints - Taxa expressa em pontos percentuais.
 * @returns Resultado correspondente à finalidade documentada: converte pontos percentuais em taxa fracionária.
 */
 ...
 *
 * @param rate - Taxa fracionária por período.
 * @returns Resultado correspondente à finalidade documentada: converte taxa fracionária em pontos percentuais.
 */
 ...
 * @param rate - Taxa fracionária por período.
 * @param periods - Quantidade de períodos.
 * @param payment - Pagamento periódico.
 * @param present - Valor financeiro presente.
 * @returns Resultado correspondente à finalidade documentada: calcula valor futuro com pagamentos no fim de cada período.
 */
 ...
 * @param periods - Quantidade de períodos.
 * @param payment - Pagamento periódico.
 * @param future - Valor financeiro futuro.
 * @returns Resultado correspondente à finalidade documentada: calcula valor presente com pagamentos no fim de cada período.
 */
