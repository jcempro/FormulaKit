 ...
 * @returns Resultado correspondente à finalidade documentada: codifica UTF-8 em Base64 sem depender de Node ou DOM.
 */
 ...
 *
 * @param value - Valor de entrada.
 * @returns Resultado correspondente à finalidade documentada: decodifica Base64 canônico em UTF-8 estrito.
 ...
 * @returns Resultado correspondente à finalidade documentada: formata quantidade de bytes em unidade binária explícita.
