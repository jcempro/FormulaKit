 ...
 * @returns Resultado correspondente à finalidade documentada: remove marcas diacríticas após normalização NFD.
 */
 ...
 * @returns Resultado correspondente à finalidade documentada: normaliza Unicode na forma solicitada.
 */
 ...
 *
 * @param value - Valor de entrada.
 * @returns Resultado correspondente à finalidade documentada: converte palavras para título sem regras linguísticas implícitas.
 */
 ...
 *
 * @param value - Valor de entrada.
 * @returns Resultado correspondente à finalidade documentada: gera slug ASCII minúsculo e determinístico.
 */
 ...
 *
 * @param value - Valor de entrada.
 * @returns Resultado correspondente à finalidade documentada: converte palavras para camelCase.
 */
 ...
 *
 * @param value - Valor de entrada.
 * @returns Resultado correspondente à finalidade documentada: converte palavras para snake_case.
 */
 ...
 *
 * @param value - Valor de entrada.
 * @returns Resultado correspondente à finalidade documentada: escapa cinco caracteres de HTML sem interpretar marcação.
 */
 ...
 *
 * @param value - Valor de entrada.
 * @returns Resultado correspondente à finalidade documentada: decodifica apenas entidades produzidas por escapeHtml.
 */
